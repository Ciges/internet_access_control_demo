<?php
/**
 *  Test 9.2:  MongoDB analyse query:  Gets the 10 domains most visited in the second half of August and the number of visits for each one.
...
$start = new MongoDate(strtotime("2012-08-15 00:00:00"));
