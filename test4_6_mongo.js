/**
 *  Test 4.6:  MongoDB analyse query:  Gets the 5 domains most visited for each month and the number of visits for each one.
 *  
 ...
 *    mongo -u mongodb -p mongodb localhost/InternetAccessLog test4_6_mongo.js
 *
