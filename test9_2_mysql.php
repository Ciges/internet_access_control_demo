<?php
/**
 *  Test 9.2:  MySQL analyse query:  Gets the 10 domains most visited in the second half of June and the number of visits for each one.
 ...
 *  This script makes part of a list of scripts to compare MySQL 5.0.26 with MyISAM tables versus MongoDB 2.2.0
 *
