<?php
/**
 *  Test 9.4:  MongoDB analyse query:  Gets the mean by day for traffic volume in August
 *  
...
$start = new MongoDate(strtotime("2012-08-01 00:00:00"));
$end = new MongoDate(strtotime("2012-08-31 23:59:59"));
...
printf("Traffic volume mean by day in bytes for August: %d\n", $result);
