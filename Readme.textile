...
In this directory there is a list of scripts used to compare MongoDB vs MySQL performance. For a full description of the work done open the document "&#8220;An Open Source NoSQL solution for Internet Access Logs Analysis&#8221;":NoSQL_Project_MSWL_Memory.odt
