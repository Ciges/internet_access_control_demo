...
mysql> grant all privileges on InternetAccessLog.* to mysqldb@localhost identified by 'mysqldb';
</code>
...
h3. Code size estimation with CLOC

For showing a size estimation of this code I have used "CLOC":http://cloc.sourceforge.net/ to count the "source lines of code":http://en.wikipedia.org/wiki/Source_lines_of_code.

The results of running cloc on this directory (excluding "doc" directory, which includes documentation in HTML generated automatically with "phpdoc":http://www.phpdoc.org/ and hidden .git directory) are:
...
86.0 files/s, 5816.0 lines/s

*Lines of code by language*

<div style="text-align: center;">
|_. Language|_. files|_. blank|_. comment|_. code|
|PHP|39|305|997|1507|
|HTML|1|0|0|51|
|SQL|1|1|13|9|
|Javascript|1|2|12|8|
|Bourne Shell|1|1|0|2|
|*SUM:*|*43*|*309*|*1022*|*1577*|
</div>