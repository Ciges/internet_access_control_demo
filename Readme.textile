...
* A presentation with a quick summary, also in "PDF":internet_access_control_demo/blob/master/NoSQL_Project_MSWL_Presentation.pdf?raw=true and OpenDocument:internet_access_control_demo/blob/master/NoSQL_Project_MSWL_Presentation.odp?raw=true formats. You can view this presentation also on "SlideShare":http://www.slideshare.net/Ciges/no-sql-projetmswlpresentation
