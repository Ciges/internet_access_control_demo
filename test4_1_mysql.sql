/**
 *  Test 4.1:  MySQL analyse query:  Gets the 10 domains most visited and the number of visits for each one.
 *  
 ...
 *    cat test4_1_mysql.sql | mysql -u mysqldb --password="mysqldb" InternetAccessLog
 *
