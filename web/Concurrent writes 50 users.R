...
loadtest_mongodb <- "C:/User/E198869/Documents/MongoDB/MongoDB_MySQL_loadtests/4 Concurrent writes 50 users - MongoDB.csv"
loadtest_mysql <- "C:/User/E198869/Documents/MongoDB/MongoDB_MySQL_loadtests/4 Concurrent writes 50 users - MySQL.csv"
...
plot(rt ~ second,
	...
	type="p",
	col="darkblue")	
title(main="Concurrent writes for 50 users")
