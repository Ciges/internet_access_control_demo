...
loadtest_mongodb <- "C:/User/E198869/Documents/MongoDB/MongoDB_MySQL_loadtests/5 Concurrent reads & writes incrementing users from 0 to 50 - MongoDB.csv"
loadtest_mysql <- "C:/User/E198869/Documents/MongoDB/MongoDB_MySQL_loadtests/5 Concurrent reads & writes incrementing users from 0 to 50 - MySQL.csv"
...
plot(rt ~ second,
	...
	type="p",
	col="darkblue")	
title(main="Concurrent read & writes, incrementing users from 0 to 50")
