...
loadtest_mongodb <- "C:/User/E198869/Documents/MongoDB/MongoDB_MySQL_loadtests/6 Concurrent reads & writes 50 users - MongoDB.csv"
loadtest_mysql <- "C:/User/E198869/Documents/MongoDB/MongoDB_MySQL_loadtests/6 Concurrent reads & writes 50 users - MySQL.csv"
...
# I don't know why but values for first second are aberrant
data_mongodb <- data_mongodb[-1,]
data_mysql <- data_mysql[-1,]
...
plot(rt ~ second,
	...
	type="p",
	col="darkblue")	
title(main="Concurrent reads & writes for 50 users")
mtext("Test made is with 50 threads from the beginning. Each thread is kept for 50 seconds", line=0.5, cex=0.8)
