 ...
 *  This script read 1 million of Non FTP log entries from CSV/NonFTP_Access_log_1million.csv and stores them in MySQL table.
...
$logentries = 10000000; # Number of log entries to read from CSV file
$entriestoread_eachtime = 100; # Number of entries to read before showing time spent
$filename = getcwd()."/CSV/NonFTP_Access_log_1million.csv";
